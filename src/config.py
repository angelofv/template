...
def load_config(
    *,
    ...
    """Load YAML config files (preproc, model, plot) and apply env overrides.

    Environment variables (PREPROC_CONFIG, MODEL_CONFIG, PLOT_CONFIG) can override file paths.
    """
    ...
    # Note: MLflow settings (URI, experiment name) will be configured at runtime
    return cfg
